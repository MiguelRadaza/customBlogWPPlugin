                ...
                <article class="d-flex">
                  <a href="#">
                    <img
                      ...
                      src="img/office/our-office-4-square.jpg"
                      alt=""
              ...
              <li class="d-flex">
                <article class="d-flex">
                  <a href="#">
                    <img
                      class="me-3 rounded-circle"
                      src="img/office/our-office-5-square.jpg"
                      alt=""
                      style="max-width: 70px"
                    />
                  </a>
              ...
              <li class="mb-3 pb-1">
                <a href="#">
                  <p class="text-3 text-color-light opacity-8 mb-1">
                    ...
                    ><strong class="ms-2">John Doe</strong> commented on
      ...
      <div class="container py-2">
        <div class="row py-4">
          <div class="col text-center">
            <ul
              class="footer-social-icons social-icons social-icons-clean social-icons-icon-light mb-3 mt-2"
            >
            ...
            <p class="text-1">
              <strong>PORTO TEMPLATE</strong> - © Copyright 2023. All Rights
              Reserved.
            </p>
          </div>
        </div>
